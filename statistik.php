<?php
//conn ke database
$conn = new mysqli("localhost", "root", "", "dpmptsp");
$bandung      = mysqli_query($conn, "SELECT * FROM permohonanbulan WHERE kota='Kota Bandung'");
$bogor          = mysqli_query($conn, "SELECT * FROM permohonanbulan WHERE kota='Kota Bogor'");
$cimahi     = mysqli_query($conn, "SELECT * FROM permohonanbulan WHERE kota='Kota Cimahi'");
$depok     = mysqli_query($conn, "SELECT * FROM permohonanbulan WHERE kota='Kota Depok'");
$kabbandung = mysqli_query($conn, "SELECT * FROM permohonanbulan WHERE kota='Kab. Bandung'");
...
$table['cols'] = array(
	...
	array('label' => 'Kota', 'type' => 'string'),
	//membuat label untuk jumlah permohonan
	array('label' => 'Jumlah Permohonan', 'type' => 'number')
);
 
//melakukan query ke database select
$sql = $conn->query("SELECT nama_kota AS kota, tahun, SUM(jumlah) AS total FROM permohonan GROUP BY nama_kota, YEAR(tahun)");
//perulangan untuk menampilkan data dari database
while($data = $sql->fetch_assoc()){
	//membuat array
	$temp = array();
	//memasukkan data pertama yaitu nama kelasnya
	$temp[] = array('v' => (string)$data['kota']);
	//memasukkan data kedua yaitu jumlah permohonan
				...
				<img src = "https://dpmptsp.jabarprov.go.id/webpengendalian/assets/images/dinas/simpatik.png">
					...
					<div class="col-sm-6">
					    <div class="panel panel-default">
								<div class="panel-heading">
									<i class="clip-bars"></i>
									Pemohon berdasarkan Wilayah Tahun 2019									
									<div class="panel-tools">
										<a class="btn btn-xs btn-link panel-collapse collapses" href="#">
										</a>
									</div>
												...
												<ul class="mini-stats col-sm-12">
														...
														<div class="values">
															...
															<div class="row">
																...
																<div class="col-sm-4">
																	<strong>15.9 Hari</strong> Rata -rata Durasi sesuai Pergub
																</div>
															</div>
															<div class="row">
																<div class="col-sm-4">
														...
														<div class="values">
															...
															<div class="row">
																...
																<div class="col-sm-4">
																	<strong>17.6 Hari</strong> Rata -rata Durasi sesuai Pergub
																</div>
															</div>
															<div class="row">
																<div class="col-sm-4">
